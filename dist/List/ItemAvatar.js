...
var ItemAvatar = function (_React$PureComponent) {
  _inherits(ItemAvatar, _React$PureComponent);
  ...
  _createClass(ItemAvatar, [{
    ...
    value: function render() {
      ...
      var props = _lodash2.default.omit(this.props, ['style', 'className', 'children', 'src', 'materialIcon']);
